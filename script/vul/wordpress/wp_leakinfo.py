...
class Script(BaseScript):
    ...
    def __init__(self):
        ...
        self.file_dic = {
            "wp-sitemap.xml": "wp-sitemap-index.xsl",
            "wp-json?static=1": "wpe_sign_on_plugin",
            "wp-json/wp/v2/users": "avatar_urls",
            "?rest_route=/wp/v2/users": "avatar_urls",
            "wp-login.php": "wp-login.php?action=lost",
        }
