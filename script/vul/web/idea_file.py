...
class Script(BaseScript):
    ...
    def __init__(self):
        ...
        self.file_dic = {
            # idea
            ".idea/dataSources.local.xml": "$PROJECT_DIR$",
            ".idea/dataSources.xml": "$PROJECT_DIR$",
            ".idea/misc.xml": "JavaScriptSettings",
            ".idea/modules.xml": "$PROJECT_DIR$",
            ".idea/sqlDataSources.xml": "$PROJECT_DIR$",
            ".idea/vcs.xml": "$PROJECT_DIR$",
