...
class Script(BaseScript):
    ...
    def __init__(self):
        ...
        self.file_dic = {
            ...
            "WEB-INF/resources/config.properties": "password",
            "WEB-INF/spring-config.xml": "<web-app",
            "WEB-INF/applicationContext.xml": "<?xml",
            "WEB-INF/config.xml": "<pattern>",
            "WEB-INF/database.propertie": '.driver',
            "WEB-INF/classes/application.properties": "password",
        }
